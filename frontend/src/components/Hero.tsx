...
export function Hero({ suggestions, onPick, onOpenPrivacy }: HeroProps) {
  return (
    <div className="animate-fadeUp pt-8">
      ...
      <button
        ...
        className="mb-3.5 cursor-pointer border-0 bg-transparent p-0 text-left text-[13px] text-accent underline underline-offset-2 hover:brightness-110"
      >
