...
// /api/chat/stream wire format ([META] provenance, data: tokens, [SOURCES]
// payload, [DONE]). The leading [META] frame also exercises the parser's
// unknown-/typed-frame handling: it must be consumed, not rendered as answer text.
export const SSE_FIXTURE = [
  "data: [META]" +
    JSON.stringify({ ai_generated: true, model: "openai/gpt-oss-120b", mode: "generated" }) +
    "\n\n",
