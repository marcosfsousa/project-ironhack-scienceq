...
def _render_sidebar() -> None:
    with st.sidebar:
        st.title("🎬 ScienceQ")
        st.caption("AI-powered Q&A about science videos from Veritasium, Kurzgesagt, and Big Think.")
...
def _render_starters() -> None:
    ...
    st.markdown(
        ...
        "<strong>ScienceQ is an AI assistant</strong> — answers are generated by a language model "
        "from the video transcripts, so mistakes are possible.\n\n"
        f"\n\nAsk questions about science and ideas from <strong>{count} curated YouTube videos</strong> — "
